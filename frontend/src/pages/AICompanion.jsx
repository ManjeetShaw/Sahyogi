...
export default function AICompanion() {
  ...
  useEffect(() => {
    api
      ...
      .catch(() => {
        // Non-fatal: chat still works without prior history loaded, but
        // let the user know their past conversation may not show up.
        setError("Couldn't load your previous conversation history.");
      });
  }, []);
